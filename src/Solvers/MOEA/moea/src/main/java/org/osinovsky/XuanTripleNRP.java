...
public class XuanTripleNRP extends AbstractBinaryProblem {
    ...
    // constructor
    public XuanTripleNRP(Map<Integer, Integer> cost,
    ...
    public void evaluate(BinarySolution solution) {
        ...
        solution.setObjective(2, customerSum);
    }
}
