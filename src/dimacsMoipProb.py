...
class DimacsMOIPProblem(MOIPProblem):  
    ...
    def readDimacsFiles(cls, projectName):
        ...
        inputPath = '../input/ALLFMs/{name}.dimacs'.format(name=projectName)
        totalFea = 0
        f= open(inputPath)
        line = f.readline()
        while line:
        ...
        inputNewPath = '../input/ALLFMs/{name}.dimacs.new'.format(name=projectName)
        totalInequal=0
        f= open(inputNewPath)
        line = f.readline()
        while line:
        ...
        inputMandFPath = '../input/ALLFMs/{name}.dimacs.mandatory'.format(name=projectName)
        ...
        inputDeadFPath = '../input/ALLFMs/{name}.dimacs.dead'.format(name=projectName)
        ...
        inputAugPath = '../input/ALLFMs/{name}.dimacs.augment'.format(name=projectName)
