...
class SolRep():
    ...
    WorkMem = 2000
    Small_TimeOut =1000
    Small_DeterTimeOut = 1000
    Big_TimeOut =10000 
    Big_DeterTimeOut = 10000
    XvarNames = None
    ...
    def initializeCplex(cls, Nv, No, a_in , b_in , aeq_in, beq_in, lbs, ubs):
        ...
        if Nv < 2000:
            solver.parameters.timelimit.set(SolRep.Small_TimeOut)
            solver.parameters.dettimelimit.set(SolRep.Small_DeterTimeOut)
        else: 
            solver.parameters.workmem.set(SolRep.WorkMem)
            solver.parameters.dettimelimit.set(SolRep.Big_TimeOut)
            solver.parameters.dettimelimit.set(SolRep.Big_DeterTimeOut)
